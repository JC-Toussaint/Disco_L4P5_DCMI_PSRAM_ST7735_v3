...
void HAL_OSPI_MspInit(OSPI_HandleTypeDef* hospi)
{
  ...
  */
    ...
    */
    GPIO_InitStruct.Pin = OCTOSPIM_P1_IO4_Pin|OCTOSPIM_P1_IO5_Pin|OCTOSPIM_P1_IO7_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    GPIO_InitStruct.Pin = OCTOSPIM_P1_CLK_Pin|OCTOSPIM_P1_IO1_Pin|OCTOSPIM_P1_IO0_Pin|OCTOSPIM_P1_NCS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF10_OCTOSPIM_P1;
    ...
    GPIO_InitStruct.Pin = OCTOSPIM_P1_IO6_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF10_OCTOSPIM_P1;
    HAL_GPIO_Init(OCTOSPIM_P1_IO6_GPIO_Port, &GPIO_InitStruct);
...
void HAL_OSPI_MspDeInit(OSPI_HandleTypeDef* hospi)
{
  ...
  /* USER CODE END OCTOSPI1_MspDeInit 0 */
    ...
    PE11     ------> OCTOSPIM_P1_NCS
    */
    HAL_GPIO_DeInit(GPIOD, OCTOSPIM_P1_IO4_Pin|OCTOSPIM_P1_IO5_Pin|OCTOSPIM_P1_IO7_Pin);

    HAL_GPIO_DeInit(OCTOSPIM_P1_DQS_GPIO_Port, OCTOSPIM_P1_DQS_Pin);

    HAL_GPIO_DeInit(GPIOE, OCTOSPIM_P1_CLK_Pin|OCTOSPIM_P1_IO1_Pin|OCTOSPIM_P1_IO0_Pin|OCTOSPIM_P1_NCS_Pin);

    HAL_GPIO_DeInit(OCTOSPIM_P1_IO6_GPIO_Port, OCTOSPIM_P1_IO6_Pin);
...
void HAL_SPI_MspDeInit(SPI_HandleTypeDef* hspi)
{
  ...
  /* USER CODE END SPI2_MspDeInit 0 */
    ...
    PB13     ------> SPI2_SCK
    */
    HAL_GPIO_DeInit(GPIOB, SPI2_MOSI_Pin|SPI2_CLK_Pin);
